...
const TaskStatusCard = ({ tasks }) => {
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-md border border-gray-100 min-w-0">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 text-center md:text-left">
        ...
        {/* Pie Chart */}
        <div className="relative flex justify-center min-w-0 w-[220px] h-[220px] md:w-[250px] md:h-[250px]">
