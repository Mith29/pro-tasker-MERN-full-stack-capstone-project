  ...
  <div className="flex flex-col items-end justify-between gap-3">
    ...
    <div className="flex gap-3">
      <button onClick={() => setIsModalOpen(true)}>
        <PencilIcon className="cursor-pointer h-5 w-5 text-blue-500 hover:text-blue-700 transition" />
      </button>

      <button onClick={handleDelete}>
        <TrashIcon className="cursor-pointer h-5 w-5 text-red-500 hover:text-red-700 transition" />
      </button>
    </div>
